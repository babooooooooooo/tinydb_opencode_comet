...
## Purpose
Provides multi-table query support through SQL JOIN operations, including INNER, LEFT, RIGHT, FULL OUTER, CROSS, and NATURAL JOIN types with three physical join algorithms (Nested Loop, Hash, Sort-Merge).
